<?php
inspect(basePath("views/renter/partials/header.php"));
?>
<?= loadPartial('header') ?>
...
<section class="breedcrumb" style="background: url('src/images/bg/bg-04.jpg') center center/cover no-repeat;">
    <div class="container">
        <h2 class="breedcrumb__title text--heading-2">Tools List</h2>
                ...
                <div class="search__content">
                    ...
                    <div class="search__content-item">
                        <div class="input-field input-field--transparent">
                            ...
                            <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-05fl" style="width: auto;">
                                <span class="selection">
                                    <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-category-tl-container" aria-controls="select2-category-tl-container">
                                        <span class="select2-selection__rendered" id="select2-category-tl-container" role="textbox" aria-readonly="true" title="Select Category">Select Category</span>
                                        <span class="select2-selection__arrow" role="presentation">
                                            <b role="presentation">
                                                <select name="category" class="js-example-basic-single w-100 select2-hidden-accessible" style="width: calc(100% - 60px);" data-select2-id="select2-data-1-43pk" tabindex="-1" aria-hidden="true">
                                                    <option value="null" style="display: none;" data-select2-id="select2-data-3-4ak4">Select Category</option>
            ...
            <div class="col-xl-3">
                <div class="list-sidebar">
                    ...
                    <div class="accordion list-sidebar__accordion" id="accordionGroup">
                            ...
                            <div id="categoryCollapse" class="accordion-collapse collapse show" aria-labelledby="category" data-bs-parent="#accordionGroup">
                                <div class="accordion-body list-sidebar__accordion-body">
                                    <div class="accordion list-sidebar__accordion-inner" id="subcategoryGroup">
                                        ...
                                        <div class="accordion-item list-sidebar__accordion-inner-item">
                                            <h2 class="accordion-header" id="buisness">
                                                <div
                                                    class="accordion-button list-sidebar__accordion-inner-button collapsed"
                                                    data-bs-toggle="collapse"
                                            ...
                                            <div id="businessCollapse" class="accordion-collapse collapse" aria-labelledby="buisness" data-bs-parent="#subcategoryGroup">
                                                <div class="accordion-body list-sidebar__accordion-inner-body">
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-7-1" />
                                                            <label class="form-check-label" for="category-item-7-1">
                                                                buisness 01
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-7-2" />
                                                            <label class="form-check-label" for="category-item-7-2">
                                                                buisness 02
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-7-3" />
                                                            <label class="form-check-label" for="category-item-7-3">
                                                                buisness 03
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-7-4" />
                                                            <label class="form-check-label" for="category-item-7-4">
                                                                buisness 04
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="accordion-item list-sidebar__accordion-inner-item">
                                            ...
                                            <div id="educationCollapse" class="accordion-collapse collapse" aria-labelledby="education" data-bs-parent="#subcategoryGroup">
                                                <div class="accordion-body list-sidebar__accordion-inner-body">
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-8-1" />
                                                            <label class="form-check-label" for="category-item-8-1">
                                                                Education 01
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-8-2" />
                                                            <label class="form-check-label" for="category-item-8-2">
                                                                Education 02
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-8-3" />
                                                            <label class="form-check-label" for="category-item-8-3">
                                                                Education 03
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="category-item-8-4" />
                                                            <label class="form-check-label" for="category-item-8-4">
                                                                Education 04
                                                            </label>
                                                        </div>
                                                    </div>
                        ...
                        <div class="accordion-item list-sidebar__accordion-item seller-type">
                            ...
                            <div id="sellerCollapse" class="accordion-collapse collapse show" aria-labelledby="sellerType" data-bs-parent="#accordionGroup">
                                <div class="accordion-body list-sidebar__accordion-body">
                                    ...
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="type" id="type4" value="option4" />
                        ...
                        <div class="accordion-item list-sidebar__accordion-item condition">
                            ...
                            <div id="conditionCollapse" class="accordion-collapse collapse show" aria-labelledby="condition" data-bs-parent="#accordionGroup">
                                <div class="accordion-body list-sidebar__accordion-body">
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="condition" id="condition1" value="option1" checked />
                                    ...
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="condition" id="condition2" value="option2" />
                                    ...
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="condition" id="condition3" value="option3" />
                        ...
                        <div class="accordion-item list-sidebar__accordion-item top-location">
                            <h2 class="accordion-header list-sidebar__accordion-header" id="topLocation">
                                <button
                                    class="accordion-button list-sidebar__accordion-button collapsed"
                                    type="button"
                                    data-bs-toggle="collapse"
                            ...
                            <div id="topLocationCollapse" class="accordion-collapse collapse show" aria-labelledby="topLocation" data-bs-parent="#accordionGroup">
                                <div class="accordion-body list-sidebar__accordion-body">
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="input-field">
                                    ...
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-1" />
                                            <label class="form-check-label" for="location-item-1">
                                                Dhaka, Bangladesh
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-2" />
                                            <label class="form-check-label" for="location-item-2">
                                                Minnesota, USA
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-3" />
                                            <label class="form-check-label" for="location-item-3">
                                                Wisconsin, USA
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-4" />
                                            <label class="form-check-label" for="location-item-4">
                                                Michigan, USA
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-5" />
                                            <label class="form-check-label" for="location-item-5">
                                                New York, USA
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-6" />
                                            <label class="form-check-label" for="location-item-6">
                                                New Mexico, USA
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-7" />
                                            <label class="form-check-label" for="location-item-7">
                                                Washington, USA
                                            </label>
                                        </div>
                                    </div>
                                    <div class="list-sidebar__accordion-inner-body--item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="location-item-8" />
                                            <label class="form-check-label" for="location-item-8">
                                                Brasilia, Brazil
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="accordion-item list-sidebar__accordion-item location-radius mobile-toggle-hide">
                            <h2 class="accordion-header list-sidebar__accordion-header" id="locationRadius">
                                <button class="accordion-button list-sidebar__accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#radiusCollapse" aria-expanded="false" aria-controls="radiusCollapse">
                                    LOCATION RADIUS <span id="value-range" class="text--body-3-600"> miles</span>
                                </button>
                            </h2>
                            <div id="radiusCollapse" class="accordion-collapse collapse show" aria-labelledby="locationRadius" data-bs-parent="#accordionGroup">
                                <div class="accordion-body list-sidebar__accordion-body">
                                    <input type="range" min="1" max="100" value="1" id="locationrange" class="sliderrange" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="price-range-slider">
                                        <div class="slider-count-wrap">
                                            <div class="slider-count">
                                                <input type="number" value="0" class="from" />
                                                <label>USD</label>
                                            </div>
                                            <div class="slider-count">
                                                <input type="number" value="1000" class="to" />
                                                <label>USD</label>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-9">
                <div class="ad-list__content row">
                    ...
                    <div class="col-lg-4">
                        <div class="cards cards--one cards--highlight">
                            <a href="ad-details.html" class="cards__img-wrapper">
                                <img src="./src/images/view/img-01.png" alt="card-img" class="img-fluid" />
                                <!-- <span class="cards__tag text--body-5">
                                            Urgents
                                        </span> -->
                            </a>
                    ...
                    <div class="col-lg-4">
                        <div class="cards cards--one">
                            <a href="ad-details.html" class="cards__img-wrapper">
                                <img src="./src/images/view/img-11.png" alt="card-img" class="img-fluid" />
                                <!-- <span class="cards__tag text--body-5">
                                            Urgents
                                        </span> -->
                            </a>
                    ...
                    <div class="col-lg-4">
                        <div class="cards cards--one">
                            <a href="ad-details.html" class="cards__img-wrapper">
                                <img src="./src/images/view/img-12.png" alt="card-img" class="img-fluid" />
                                <!-- <span class="cards__tag text--body-5">
                                            Urgents
                                        </span> -->
                            </a>
                    ...
                    <div class="col-lg-4">
                        <div class="cards cards--one">
                            <a href="ad-details.html" class="cards__img-wrapper">
                                <img src="./src/images/view/img-13.png" alt="card-img" class="img-fluid" />
                                <span class="cards__tag text--body-5">
                                    Urgents
                                </span>
                            </a>
                    ...
                    <div class="col-lg-4">
                        <div class="cards cards--one">
                            <a href="ad-details.html" class="cards__img-wrapper">
                                <img src="./src/images/view/img-14.png" alt="card-img" class="img-fluid" />
                                <!-- <span class="cards__tag text--body-5">
                                            Urgents
                                        </span> -->
                            </a>
                    ...
                    <div class="col-lg-4">
                        <div class="cards cards--one">
                            <a href="ad-details.html" class="cards__img-wrapper">
                                <img src="./src/images/view/img-15.png" alt="card-img" class="img-fluid" />
                                <!-- <span class="cards__tag text--body-5">
                                            Urgents
                                        </span> -->
                            </a>
