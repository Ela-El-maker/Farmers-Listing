<div class="dashboard__count-card row">
    <div class="col-lg-12">
        <div class="dashboard-card dashboard-card--warning bgcolor--warning text--center">
            <div class="dashboard-card--warning__info">
                <h2 class="warning-title text--heading-2"
                    style="color: #FFAA00; font-weight: bold; margin-bottom: 10px;">
                    Profile Incomplete
                </h2>
                <p class="warning-message text--body-3"
                    style="color: #333; font-size: 1rem; margin-bottom: 20px;">
                    Your profile is incomplete! Completing it will help you unlock more features and
                    improve your experience.
                </p>
                <a href="/profile-edit" class="btn btn--primary"
                    style="padding: 10px 20px; font-size: 1rem; background-color: #FFAA00; color: #fff; border: none; border-radius: 5px; text-decoration: none; display: inline-block;">
                    Complete Profile Now
                </a>
            </div>
            <div class="dashboard-card--warning__icon" style="margin-top: 20px;">
                <span class="icon">
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M25 4.16667C36.5925 4.16667 45.8333 13.4075 45.8333 25C45.8333 36.5925 36.5925 45.8333 25 45.8333C13.4075 45.8333 4.16667 36.5925 4.16667 25C4.16667 13.4075 13.4075 4.16667 25 4.16667Z"
                            stroke="#FFAA00" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M25 15V25" stroke="#FFAA00" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M25 33.3333H25.0167" stroke="#FFAA00" stroke-width="3"
...
<div class="dashboard__count-card row">
    <div class="col-lg-4">
        <div class="dashboard-card dashboard-card--count bgcolor--primary-9">
            <div class="dashboard-card--count__info">
                <span class="counter-number text--heading-2">24</span>
                <h2 class="counter-title text--body-3">Public Documents</h2>
            </div>
            <div class="dashboard-card--count__icon">
                <span class="icon">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 23.75H25" stroke="#00AAFF" stroke-width="2.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M15 18.75H25" stroke="#00AAFF" stroke-width="2.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        <path
                            ...
                            stroke="#00AAFF" stroke-width="2.5" stroke-linecap="round"
    ...
    <div class="col-lg-4">
        <div class="dashboard-card dashboard-card--count bgcolor--success-9">
            <div class="dashboard-card--count__info">
                <span class="counter-number text--heading-2">43</span>
                <h2 class="counter-title text--body-3">Private Documents</h2>
            </div>
            <div class="dashboard-card--count__icon">
                <span class="icon">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 20H11.25L13.75 16.25L18.75 23.75L21.25 20H25" stroke="#27C200"
    ...
    <div class="col-lg-4">
        <div class="dashboard-card dashboard-card--count bgcolor--danger-9">
            <div class="dashboard-card--count__info">
                <span class="counter-number text--heading-2">27</span>
                <h2 class="counter-title text--body-3">Organisations</h2>
            </div>
            <div class="dashboard-card--count__icon">
                <span class="icon">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                        ...
                        <path d="M34.8279 11.6607L20.1485 20.0003L5.17334 11.6592" stroke="#FF4F4F"
                            stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        </path>
                        <path d="M20.1481 20L20.0015 36.6908" stroke="#FF4F4F" stroke-width="2.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </span>
            </div>
...
<div class="row dashboard__ads-activity">
    ...
    <div class="col-lg-12">
        <div class="dashboard-card dashboard-card--recent">
            <h2 class="dashboard-card__title">Recents Activities</h2>
            <ul class="dashboard-card--recent__activity">
                <li class="dashboard-card--recent__activity-item success">
                    <span class="icon">
                    ...
                    <p class="text--body-3">Your document <span class="quote">“v21 48mp ois
                            slefie”</span> is successful published. <a href="#">View document</a>
                    </p>
                </li>
                <li class="dashboard-card--recent__activity-item primary">
                    <span class="icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 14.25H15" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9 11.25H15" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
                                ...
                                stroke="#00AAFF" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                    ...
                    <p class="text--body-3">
                        John Wick saved your document to his favourite collection.
                    </p>
                </li>
                <li class="dashboard-card--recent__activity-item warning">
                    <span class="icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke-linejoin="round" />
                            <path d="M11.25 11.25H12V16.5H12.75" stroke="currentColor"
                            ...
                            <path
                                ...
                                fill="#FFBF00" stroke="#FFBF00" stroke-width="1.5" />
                        </svg>
                    </span>
                    <p class="text--body-3">
                        Please complete your profile editing to post documents.
                    </p>
                </li>
                <li class="dashboard-card--recent__activity-item success">
                    <span class="icon">
                    ...
                    <p class="text--body-3">Your document <span class="quote">“converse blue
                            training shoes”</span> is successful published. <a href="#">View
                            document</a></p>
                </li>
                <li class="dashboard-card--recent__activity-item danger">
                    <span class="icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 9.75V13.5" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
...
<div class="dashboard__posted-ads">
    <div class="dashboard__section-info">
        <h2 class="dashboard-card__title">Recently Posted Documents</h2>

        <a href="myad.html" class="view-page">
            View All
            <span class="icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.75 12H20.25" stroke="#939AAD" stroke-width="1.6"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M13.5 5.25L20.25 12L13.5 18.75" stroke="#939AAD" stroke-width="1.6"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </span>
        </a>
                ...
                <div class="cards__info">
                    <div class="cards__info-top">
                        <h6 class="text--body-4 cards__category-title">
                            <span class="icon">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 11L8 14.5L14 11" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M2 8L8 11.5L14 8" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M2 5L8 8.5L14 5L8 1.5L2 5Z" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </span>
                            Home &amp; Living
                        ...
                        <a href="ad-details.html"
                            class="text--body-3-600 cards__caption-title">Toyota Fielder G HYBRID
                            WXB PE...</a>
                    </div>
                                            ...
                                            <span class="icon">
                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                    ...
                                                    <path d="M10.625 5L15 9.375"
                                                        ...
                                                        stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                    <path d="M16.8748 16.8753H7.49979L3.16455 12.54"
                                                        stroke="currentColor" stroke-width="1.3"
                                                        stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                </svg>
                                            </span>
                                            <h5 class="text--body-4">Edit Ads Details</h5>
                                        </a>
                                    </li>
                                    <li class="edit-dropdown__item">
                                        <a href="#" class="edit-dropdown__link">
                                    ...
                                    <li class="edit-dropdown__item">
                                        <a href="#" class="edit-dropdown__link">
                                            <span class="icon">
                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M16.8745 4.375L3.12451 4.37501"
                                                        stroke="currentColor" stroke-width="1.3"
                                                        stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
